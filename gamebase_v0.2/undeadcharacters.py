...
class Howleress(bc.BaseCharacter):
    ...
    def __init__(self):
        ...
        self.strenght = 11
        self.initiative = 12
        self.Active_skills ={'Атака': [self.Attack, 'target'],
                              'Не время умирать!': [self.RaiseTheDead, 'f_target'], 
                              'Вой по живым': [self.Healing, 'f_target'],
                              'Mass Healing': [self.Mass_Healing, 'f_team']}
        self.Passive_skills = {}
